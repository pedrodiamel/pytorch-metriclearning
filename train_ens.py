...
from torchlib.neuralnet import NeuralNetExpertClassifier
...
def main():
    ...
    network = NeuralNetExpertClassifier(
    ...
    val_loader = DataLoader(val_data, batch_size=args.batch_size_test, 
