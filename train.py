...
def arg_parser():
    ...
    parser.add_argument('--parallel', action='store_true', default=False,
                        help='Parallel')
    parser.add_argument('--emb-dim', default=2, type=int, metavar='N',
...
def main():
    ...
    network.create( 
        arch=args.arch, 
        num_output_channels=args.emb_dim, 
    ...
    train_data = TripletsDataset(
        data=FactoryDataset.factory(pathname=args.data, name=args.name_dataset, subset=FactoryDataset.training, download=True ),
