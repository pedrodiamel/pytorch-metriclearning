...
def arg_parser():
    ...
    parser.add_argument('--batch-size-train', default=256, type=int, metavar='N', 
                        help='mini-batch size for train (default: 256)')
    parser.add_argument('--batch-size-test', default=256, type=int, metavar='N', 
                        help='mini-batch size for test (default: 256)')
    ...
    parser.add_argument('--dim', default=2, type=int, metavar='N',
    ...
    parser.add_argument('--triplet-size-train', default=1000, type=int, metavar='N', 
                        help='triplet-data for training size (default: 1000)')
    parser.add_argument('--triplet-size-val', default=100, type=int, metavar='N', 
                        help='triplet-data size for validation (default: 100)')
...
def main():
    ...
    print('Triplet representation {}!!!'.format(datetime.datetime.now()))
    print('\nArgs:')
